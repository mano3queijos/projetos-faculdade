...
<div class="container">
	...
	<form action="/blog/salvar" method="post">
		<div class="form-floating mb-3">
  			<input name="titulo" required="required" type="text" class="form-control" id="tituloId" placeholder="Seu Titulo...">
  			<label for="tituloId" class="form-label">Titulo:</label>
		</div>
		<div class="form-floating mb-3">
  			<textarea required="required" class="form-control" placeholder=" " id="textoId"  name="texto" ></textarea>
